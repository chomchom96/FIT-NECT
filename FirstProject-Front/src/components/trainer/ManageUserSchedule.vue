<template>
  <div class="container py-7" style="margin-top: 50px;">
    <h2 class="text-uppercase text-letter-spacing-xs my-0 text-primary font-weight-bold" style="text-align: center; ">
      사용자 스케줄 관리
    </h2>
    <br>
    <p class="text-sm text-dark mt-0 mb-5" style="text-align: center; ">맞춤형 스케줄을 관리하세요!</p>
    <div class="row">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <div class="input-group mb-3">
            ...
            <input style="margin-right:30px;" type="time" id="startTime" v-model="startTime" class="form-control" required min="2023-11-21" max="9999-12-31"/>
